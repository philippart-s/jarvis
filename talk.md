...
# Do the demo
  ...
  - run [46-without-mcp.sh](./bin/46-without-mcp.sh)
  - run [47-add-quarkus-mcp-client.sh](bin/47-add-quarkus-mcp-client.sh)
  ...
  - run [56-add-quarkus-agentic.sh](bin/56-add-quarkus-agentic.sh)
  - create [ClassifierAgent.java](./src/main/java/fr/wilda/picocli/sdk/ai/agent/common/ClassifierAgent.java) (👨‍💻 `57-classifier-enum-agent` && `58-classifier-agent`)
  - create [ChatAgent.java](./src/main/java/fr/wilda/picocli/sdk/ai/agent/common/ChatAgent.java) (👨‍💻 `59-chat-agent`)
  - create [RagTool.java](./src/main/java/fr/wilda/picocli/sdk/ai/agent/tool/RagTool.java) (👨‍💻 `60-rag-tool`)
  - create [RagAgent](./src/main/java/fr/wilda/picocli/sdk/ai/agent/common/RagAgent.java) (👨‍💻 `61-rag-agent`)
